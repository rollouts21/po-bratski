    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=150, verbose_name='Ссылка на товар (заполняется автоматически)')),
                ('image', models.ImageField(blank=True, upload_to='products/%Y/%m/%d', verbose_name='Изображение')),
                ('description', models.TextField(blank=True, verbose_name='Описание букета (не обязательно)')),
                ...
                ('discount', models.DecimalField(decimal_places=2, default=0.0, max_digits=4, verbose_name='скидка в процентах')),
